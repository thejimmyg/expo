...
import main.kotlin.expo.modules.splashscreen.SplashScreen;
...
public class MainActivity extends ReactActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    SplashScreen.show(this, SplashScreenMode.COVER); // THIS LINE IS HANDLED BY 'expo-splash-screen' COMMAND AND IT'S DISCOURAGED TO MODIFY IT MANUALLY
